"""
Testprogramm Luftschiff zur Überprüfung der I2C-Funktionalitöt der Sensorik
...
def runLaser():
	...
	time.sleep(.005)
	mySensor.get_distance()	 # Get the result of the measurement from the sensor
	time.sleep(.005).stop_ranging()
